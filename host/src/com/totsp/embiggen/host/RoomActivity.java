 ...
 */
final public class RoomActivity extends BaseActivity {
               ...
               public void run() {
                  ...
                  if (haveNetworkNow) {
                     if (haveNetwork.isPresent() && !haveNetwork.get()) {
                        Toast.makeText(RoomActivity.this, getString(R.string.network_connection_restored),
                                 Toast.LENGTH_SHORT).show();
                     }
                     connect();
                  } else {
                     if (haveNetwork.isPresent() && haveNetwork.get()) {
                        Toast.makeText(RoomActivity.this, getString(R.string.network_connection_lost),
                                 Toast.LENGTH_SHORT).show();
                     }
                     transitionToDisconnected();
                  }
                  haveNetwork = Optional.of(haveNetworkNow);
                  Log.i(RoomActivity.class.getSimpleName(), "set mHaveNetwork to " + haveNetwork);
               }
            });
         }
      };
   ...
   protected synchronized void onStart() {
      super.onStart();
      Log.i(RoomActivity.class.getSimpleName(), "in onStart(); haveNetwork is " + haveNetwork);
